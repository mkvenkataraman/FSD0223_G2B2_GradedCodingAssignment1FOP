...
/**
As per Great Learning Standard "DriverClass" is the name to be used for the "Main" class.
As the problem statement states "Driver class Main will be used" the class 
is named as "Main"
**/
public class Main {
